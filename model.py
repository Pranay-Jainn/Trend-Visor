def prediction(stock, n_days):
    ...
    if len(X) < 2:
        raise ValueError("Not enough data to perform training and testing.")
    ...
    fig.add_trace(go.Scatter(x=dates, y=best_svr.predict(output_days), mode='lines+markers', name='predicted'))
